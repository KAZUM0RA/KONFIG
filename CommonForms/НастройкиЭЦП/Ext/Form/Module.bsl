	...
	Если СпискиАлгоритмовУспешноЗаполнены Тогда
		...
		Если Не ЗначениеЗаполнено(АлгоритмПодписи) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Выберите алгоритм подписи';uk='Виберіть алгоритм підпису'"), , "АлгоритмПодписи", , Отказ);
		КонецЕсли;	
		
		Если Не ЗначениеЗаполнено(АлгоритмХеширования) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Выберите алгоритм хеширования';uk='Виберіть алгоритм хеширування'"), , "АлгоритмХеширования", , Отказ);
		КонецЕсли;	
		
		Если Не ЗначениеЗаполнено(АлгоритмШифрования) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Выберите алгоритм шифрования';uk='Виберіть алгоритм шифрування'"), , "АлгоритмШифрования", , Отказ);
		КонецЕсли;	
