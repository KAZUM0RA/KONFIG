...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ДокументОписаниеОбновлений.ВысотаТаблицы = 0 Тогда
		Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Конфигурация успешно обновлена на версию %1';uk='Конфігурація успішно оновлена на версію %1'"), Метаданные.Версия);
...
Процедура ЗаписатьТекущиеНастройки(Знач ПоказыватьПриСледующихОбновлениях)
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("ОбновлениеИБ", "НеПоказыватьОписаниеИзмененийСистемы",
		НЕ ПоказыватьПриСледующихОбновлениях, НСтр("ru='Не показывать описание изменений системы при обновлении версии ИБ';uk='Не показывать описание изменений системы при обновлении версии ИБ'"));
