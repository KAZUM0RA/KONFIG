...
Процедура ЛичныйСертификатНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если НЕ ПодключитьРасширениеРаботыСКриптографией() Тогда
		Предупреждение(НСтр("ru='Для выбора сертификата вам нужно установить расширение работы с криптографией.';uk=' Для вибору сертифіката вам потрібно встановити розширення роботи із криптографією.'"));
		Возврат;
	КонецЕсли;
