...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимПодбора Тогда
		Заголовок = НСтр("ru='Подбор узлов планов обмена';uk='Добір вузлів планів обміну'");
	КонецЕсли;
...
Процедура Выбрать(Команда)
	...
	Иначе
		...
		Если ТекущиеДанные = Неопределено Тогда
			Предупреждение(НСтр("ru='Узел не выбран.';uk='Вузол не обраний.'"));
		Иначе
...
Процедура ДобавитьИспользуемыйПланОбмена(ОбъектМетаданных)
	...
	Если Параметры.ВыбиратьВсеУзлы Тогда
		...
		НоваяСтрока.УзелПредставление       = НСтр("ru='<Все узлы>';uk='<Усі вузли>'");
	КонецЕсли;
