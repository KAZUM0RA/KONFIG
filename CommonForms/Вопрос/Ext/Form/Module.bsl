...
Функция СтандартныйНабор(Кнопки)
	...
	Если      Кнопки = "РежимДиалогаВопрос.ДаНет" Тогда
		...
		Результат.Добавить("КодВозвратаДиалога.Нет",        НСтр("ru='Нет';uk='Немає'"));
	ИначеЕсли Кнопки = "РежимДиалогаВопрос.ДаНетОтмена" Тогда
		Результат.Добавить("КодВозвратаДиалога.Да",         НСтр("ru='Да';uk='Так'"));
		Результат.Добавить("КодВозвратаДиалога.Нет",        НСтр("ru='Нет';uk='Немає'"));
		Результат.Добавить("КодВозвратаДиалога.Отмена",     НСтр("ru='Отмена';uk='Скасування'"));
...
Функция ПолучитьЗаголовокКнопкиТаймаута(Заголовок, ЧислоСекунд)
	...
	Шаблон = НСтр("ru='%1 (осталось %2 сек.)';uk='%1 (залишилося %2 сек.)'");
