...
Процедура ОбновитьДеревоСтруктурыПодчиненности()
	...
	Иначе
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			Нстр("ru='Документ, для которого сформирован отчет о структуре подчиненности, стал недоступен.';uk='Документ, для якого сформований звіт про структуру підпорядкованості, став недоступний.'"));
	КонецЕсли;
