...
Функция ОшибкаОткрытияФайлаСообщенияОбмена()
	...
	Возврат НСтр("ru='Ошибка открытия файла сообщения обмена';uk='Помилка відкриття файлу повідомлення обміну'");
	
КонецФункции

Функция ОшибкаНачалаЧтенияФайлаСообщенияОбмена()
	
	Возврат НСтр("ru='Ошибка при начале чтения файла сообщения обмена';uk='Помилка при початку читання файлу повідомлення обміну'");
	
КонецФункции

Функция ОшибкаЧтенияФайлаСообщенияОбмена()
	
	Возврат НСтр("ru='Ошибка чтения файла сообщения обмена';uk='Помилка читання файлу повідомлення обміну'");
...
Функция ОшибкаВидаОбменаДанными()
	...
	Возврат НСтр("ru='Обмен не по правилам конвертации не поддерживается';uk='Обмін не за правилами конвертації не підтримується'");
