...
Функция СоздатьВременныйКаталогСообщенийОбмена()
	...
	Иначе
		...
		мВременныйКаталогСообщенийОбмена = Новый Файл(ИмяКаталогаОбменаИнформацией());
...
Функция СоздатьФайлПроверки()
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru='Обмен данными';uk='Обмін даними'"), УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		Возврат Ложь;
	КонецПопытки;
...
Процедура ИнициализацияСообщенийОшибок()
	...
	мСообщенияОшибок.Вставить(1, НСтр("ru='Ошибка подключения: Не указан каталог обмена информацией.';uk='Помилка підключення: Не зазначений каталог обміну інформацією.'"));
	мСообщенияОшибок.Вставить(2, НСтр("ru='Ошибка подключения: Каталог обмена информацией не существует.';uk='Помилка підключення: Каталог обміну інформацією не існує.'"));
	
	мСообщенияОшибок.Вставить(3, НСтр("ru='В каталоге обмена информацией не был обнаружен файл сообщения с данными.';uk='У каталозі обміну інформацією не був виявлений файл повідомлення з даними.'"));
	мСообщенияОшибок.Вставить(4, НСтр("ru='Ошибка при распаковке сжатого файла сообщения.';uk='Помилка при розпакуванні стислого файлу повідомлення.'"));
	мСообщенияОшибок.Вставить(5, НСтр("ru='Ошибка при сжатии файла сообщения обмена.';uk='Помилка при стиску файлу повідомлення обміну.'"));
	мСообщенияОшибок.Вставить(6, НСтр("ru='Ошибка при создании временного каталога';uk='Помилка при створенні тимчасового каталогу'"));
	мСообщенияОшибок.Вставить(7, НСтр("ru='Архив не содержит файл сообщения обмена';uk='Архів не містить файл повідомлення обміну'"));
	
	мСообщенияОшибок.Вставить(8, НСтр("ru='Ошибка записи файла в каталог обмена информацией. Проверьте права пользователя на доступ к каталогу.';uk='Помилка запису файлу в каталог обміну інформацією. Перевірте права користувача на доступ до каталогу.'"));
	мСообщенияОшибок.Вставить(9, НСтр("ru='Ошибка удаления файла из каталога обмена информацией. Проверьте права пользователя на доступ к каталогу.';uk='Помилка видалення файлу з каталогу обміну інформацією. Перевірте права користувача на доступ до каталогу.'"));
