...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ИмяФайлаСообщенияОбмена") Тогда
		...
		НСтрока = НСтр("ru='Форма не может быть открыта интерактивно.';uk='Форма не може бути відкрита интерактивно.'");
...
Процедура ПередЗакрытием(Отказ, СтандартнаяОбработка)
	...
	Если  Объект.ТаблицаАвтоматическиСопоставленныхОбъектов.Количество() > 0
		...
		Предупреждение(НСтр("ru='Форма содержит данные автоматического сопоставления. Действие отменено.';uk='Форма містить дані автоматичного зіставлення. Дія скасована.'"));
