...
Процедура ОбновитьТекстПоясняющейНадписи()
	...
	Если МассивОтмеченныхЭлементовСписка.Количество() = 0 Тогда
		...
		ПоясняющаяНадпись = НСтр("ru='Сопоставление будет выполнено только по уникальным идентификаторам объектов.';uk=""Зіставлення буде виконано тільки по унікальних ідентифікаторах об'єктів.""");
		
	Иначе
		
		ПоясняющаяНадпись = НСтр("ru='Сопоставление будет выполнено по уникальным идентификаторам объектов и по выбранным полям.';uk=""Зіставлення буде виконано по унікальних ідентифікаторах об'єктів і по обраних полях.""");
