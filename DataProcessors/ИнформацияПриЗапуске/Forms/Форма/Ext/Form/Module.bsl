...
Процедура ПриОткрытии(Отказ)
	...
	Если ОтсутствуютДанныеДляОтображения ИЛИ НЕ ПоказыватьПриНачалеРаботы Тогда
		Отказ = Истина;
	КонецЕсли;
...
Процедура ПриЗакрытии()
	Если ПравоСохраненияДанных Тогда
...
Функция ПодготовитьДанныеФормы()
	...
	Для Каждого СтрокаТаблицы Из ДобавленныеКоманды Цикл
		...
		Если НаименованиеТекущегоРаздела <> НаименованиеРаздела Тогда
			...
			Если НаименованиеРаздела = НСтр("ru='Главная';uk='Головна'") ИЛИ НаименованиеРаздела = "" Тогда
		...
		СтрокаТаблицы.ЗаголовокФормы = НСтр("ru='Информация';uk='Інформація'");
		...
		Если СтрокаТаблицы.ИмяМакета = "СайтОСМД" Тогда
			СтрокаТаблицы.ЗаголовокФормы = "Особистий кабiнет ХВОЯ:Сайт ЖКГ";
		КонецЕсли;
...
Процедура РазместитьСтраницыКоманды(СтрокаТаблицы)
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Стандартные подсистемы. Дополнительная информация';uk='Стандартні підсистеми. додаткова інформація'"),
