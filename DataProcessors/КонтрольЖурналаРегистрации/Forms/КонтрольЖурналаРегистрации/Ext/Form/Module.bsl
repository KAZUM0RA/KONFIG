...
Процедура ОбновитьОтчетНаФорме(Команда)
	...
	Если Не ЗначениеЗаполнено(НачалоПериодаВыборки) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Не заполнено начало периода выборки.';uk='Не заповнений початок періоду вибірки.'"),
			,
	...
	Если Не ЗначениеЗаполнено(ОкончаниеПериодаВыборки) Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Не заполнено окончание периода выборки.';uk='Не заповнене закінчення періоду вибірки.'"),
			,
