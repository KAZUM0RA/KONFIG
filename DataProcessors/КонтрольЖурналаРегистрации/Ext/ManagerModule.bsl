...
Процедура СформироватьОтчетПоОшибкамИПослатьОтчет(Знач НачалоПериодаВыборки = Неопределено,
	...
	ПараметрыПисьма.Вставить("Тема",
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='Контроль журнала регистрации: %1.';uk='Контроль журналу реєстрації: %1.'"),
			ПредставлениеИБ));
...
"За более детальной информацией необходимо обращаться к журналу регистрации.';uk='Информация по ошибкам и предупреждениям журнала регистрации."
"Информационная база: %1."
"Период выборки данных: c %2 по %3."
"Всего ошибок: %4."
"Всего предупреждений: %5."
