...
Процедура ПолеКаталогРезервнойКопииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Диалог.Заголовок = НСтр("ru='Выбор каталога резервной копии ИБ';uk='Выбор каталога резервной копии ИБ'");
...
Процедура КомандаОК(Команда)
	...
	Если Объект.СоздаватьРезервнуюКопию = 2 Тогда
		...
		Если Отказ Тогда
			Предупреждение(НСтр("ru='Укажите существующий каталог для сохранения резервной копии ИБ.';uk='Укажите существующий каталог для сохранения резервной копии ИБ.'"));
