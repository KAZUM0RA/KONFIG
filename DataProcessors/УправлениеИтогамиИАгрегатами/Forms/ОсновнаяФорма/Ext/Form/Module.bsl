...
Процедура ВключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Включение использования итогов завершено';uk='Включення використання підсумків завершене'"));
...
Процедура ВключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Включение использования текущих итогов завершено';uk='Включення використання поточних підсумків завершене'"));
...
Процедура ВыключитьИспользованиеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Выключение использования итогов ...';uk='Вимикання використання підсумків ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Выключение использования итогов завершено';uk='Вимикання використання підсумків завершене'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка выключения использования итогов.';uk='Помилка вимикання використання підсумків.'"));
...
Процедура ВыключитьИспользованиеТекущихИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Выключение использования текущих итогов ...';uk='Вимикання використання поточних підсумків ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Выключение использования текущих итогов завершено';uk='Вимикання використання поточних підсумків завершене'"));
	ПараметрыИтогов.Вставить("Действие",               "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользоватьТекущиеИтоги");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка выключения использования текущих итогов.';uk='Помилка вимикання використання поточних підсумків.'"));
...
Процедура УстановитьПериодИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка установки периода рассчитанных итогов.';uk='Помилка установки періоду розрахованих підсумків.'"));
...
Процедура ВключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Включение разделения итогов завершено';uk='Включення поділу підсумків завершене'"));
...
Процедура ВыключитьРазделениеИтогов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Выключение разделения итогов ...';uk='Вимикання поділу підсумків ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Выключение разделения итогов завершено';uk='Вимикання поділу підсумків завершене'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРазделениеИтогов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РазделениеИтогов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка выключения разделения итогов.';uk='Помилка вимикання поділу підсумків.'"));
...
Процедура ВключитьРежимАгрегатов(Команда)
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Включение режима агрегатов завершено';uk='Включення режиму агрегатів завершене'"));
...
Процедура ВключитьРежимИтогов(Команда)
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Включение режима итогов завершено';uk='Включення режиму підсумків завершене'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьРежимАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "РежимАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
...
Процедура ВключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Включение использования агрегатов завершено';uk='Включення використання агрегатів завершене'"));
...
Процедура ВыключитьИспользованиеАгрегатов(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Выключение использования агрегатов ...';uk='Вимикання використання агрегатів ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Выключение использования агрегатов завершено';uk='Вимикання використання агрегатів завершене'"));
	ПараметрыИтогов.Вставить("Действие",               "УстановитьИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "ИспользованиеАгрегатов");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка выключения использования агрегатов.';uk='Помилка вимикання використання агрегатів.'"));
...
Процедура ПерестроитьАгрегаты(Команда)
	...
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Перестроение агрегатов завершено';uk='Перебудування агрегатів завершене'"));
	...
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка перестроения агрегатов.';uk='Помилка перебудування агрегатів.'"));
...
"Выполнить очистку?';uk='Очищення агрегатів приведе до істотної затримки звітів. Виконати очищення?'");
...
Процедура АгрегатыОптимальные(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Получение списка оптимальных агрегатов ...';uk='Одержання списку оптимальних агрегатів ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Получение списка оптимальных агрегатов завершено';uk='Одержання списку оптимальних агрегатів завершене'"));
	ПараметрыИтогов.Вставить("Действие",               "ПолучитьОптимальныеАгрегаты");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.АгрегатыПоРегистрам.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Результат.ОтносительныйРазмер);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка получения списка оптимальных агрегатов.';uk='Помилка одержання списку оптимальних агрегатів.'"));
...
Процедура УстановитьПериодРасчитанныхИтогов(Команда)
	...
	Если МассивДействий.Количество() = 0 Тогда
		Предупреждение(НСтр("ru='Отсутствуют регистры, для которых можно выполнить данную операцию.';uk=' Відсутні регістри, для яких можна виконати дану операцію.'"));
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьАгрегатыИВыполнитьПерестроение(Команда)
	...
	Если МассивДействий.Количество() = 0 Тогда
		Предупреждение(НСтр("ru='Отсутствуют регистры, для которых можно выполнить выбранное действие.';uk=' Відсутні регістри, для яких можна виконати обрана дія.'"));
		Возврат;
	КонецЕсли;
...
Процедура ПересчитатьИтоги(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Пересчет итогов ...';uk='Перерахування підсумків ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Пересчет итогов завершен';uk='Перерахування підсумків завершене'"));
	ПараметрыИтогов.Вставить("Действие",               "ПересчитатьИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка пересчета итогов.';uk='Помилка перерахування підсумків.'"));
...
Процедура ПересчитатьТекущиеИтоги(Команда)
	...
	ПараметрыИтогов = Новый Структура;
	ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Пересчет текущих итогов ...';uk='Перерахування поточних підсумків ...'"));
	ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Пересчет текущих итогов завершен';uk='Перерахування поточних підсумків завершений'"));
	ПараметрыИтогов.Вставить("Действие",               "ПересчитатьТекущиеИтоги");
	ПараметрыИтогов.Вставить("МассивСтрок",            Элементы.СписокИтогов.ВыделенныеСтроки);
	ПараметрыИтогов.Вставить("Поле",                   "Наименование");
	ПараметрыИтогов.Вставить("Значение1",              Ложь);
	ПараметрыИтогов.Вставить("Значение2",              Неопределено);
	ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка пересчета текущих итогов.';uk='Помилка перерахування поточних підсумків.'"));
...
Процедура ПересчитатьИтогиЗаПериод(Команда)
	...
	Если Диалог.Редактировать() Тогда
		...
		ПараметрыИтогов = Новый Структура;
		ПараметрыИтогов.Вставить("ОбрабатыватьЗаголовок",  НСтр("ru='Пересчет итогов за период ...';uk='Перерахування підсумків за період ...'"));
		ПараметрыИтогов.Вставить("ПослеПроцесса",          НСтр("ru='Пересчет итогов за период завершен';uk='Перерахування підсумків за період завершений'"));
		...
		ПараметрыИтогов.Вставить("ТекстСообщенияОбОшибке", НСтр("ru='Ошибка пересчета итогов за период.';uk='Помилка перерахування підсумків за період.'"));
...
Процедура ПрочитатьИнформациюПоРегистрам()
	...
	Для Каждого Регистр Из Метаданные.РегистрыНакопления Цикл
		...
		Если Регистр.ВидРегистра = Метаданные.СвойстваОбъектов.ВидРегистраНакопления.Обороты Тогда
			Оборотный = Ложь;
			Постфикс = НСтр("ru=' (Оборотный Регистр Накопления)';uk=' (Оборотний Регістр Нагромадження)'");
		Иначе
			Оборотный = Истина;
			Постфикс = НСтр("ru=' (Регистр Накопления)';uk=' (Регістр Нагромадження)'");
		КонецЕсли;
...
Функция Префикс()
	...
	Возврат НСтр("ru='Агрегаты регистра';uk='Агрегати регістру'");
...
"""%1"".';uk='Помилка запису файлу оптимальних агрегатів: ""%1"".'"),
				КраткоеПредставлениеОшибки(ИнформацияОбОшибке) ));
...
Процедура УстановитьРасширенныйРежим()
	...
	Если ПолныеВозможности Тогда
		Заголовок        = НСтр("ru='Управление итогами - полные возможности';uk='Керування підсумками - повні можливості'");
	...
	Иначе
		Заголовок        = НСтр("ru='Управление итогами - часто используемые возможности';uk='Керування підсумками - часто використовувані можливості'");
