...
Перем ФлагКомментироватьОбработкуОбъектов Экспорт; // признак комментирования обработки объектов
...
Перем одТипУзлаXML_КонецЭлемента  Экспорт;	// Тип узла("КонецЭлемента")
Перем одТипУзлаXML_НачалоЭлемента Экспорт;  // Тип узла("НачалоЭлемента")
Перем одТипУзлаXML_Текст          Экспорт;  // Тип узла("Текст")
...
Перем мСоответствиеДопПараметровПоиска; // Соответствие для дополнительных параметров поиска 
Перем мСоответствиеПравилКонвертации; // Соответствие для определения правила конвертации объекта по типу этого объекта

Перем мОбработкаДляЗагрузкиДанных Экспорт; // Обработка загрузки данных

Перем мСоответствиеПустыхЗначенийТипов;
Перем мСоответствиеОписаниеТипов;

Перем мБылиПрочитаныПравилаОбменаПриЗагрузке Экспорт; // Признак того, что правила были прочитаны
...
Процедура ЗагрузитьПравилаОбмена(Источник="", ТипИсточника="XMLФайл") Экспорт
	...
	Если Конвертация.Свойство("ПослеЗагрузкиПравилОбмена", ТекстСобытияПослеЗагрузкиПравилОбмена)
		...
		Исключение
			...
			Текст = НСтр("ru='Обработчик: ""ПослеЗагрузкиПравилОбмена"": ';uk='Оброблювач: ""ПослеЗагрузкиПравилОбмена"": '") + КраткоеПредставлениеОшибки(ИнформацияОбОшибке()); 
			СообщитьПользователю(Текст);
