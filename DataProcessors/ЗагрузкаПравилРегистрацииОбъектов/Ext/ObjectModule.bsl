...
"Дата создания:   %1"
"План обмена:     %2"
"Конфигурация:    %3';uk=""Правила реєстрації об'єктів Дата створення:   %1 План обміну:     %2 Конфігурація:    %3""");
	//
...
Функция ИнициализацияСообщений()
	...
	Сообщения.Вставить(5, НСтр("ru='Загружаемые правила регистрации не предназначены для текущего плана обмена.';uk=' правила, що завантажуються, реєстрації не призначені для поточного плану обміну.'"));
