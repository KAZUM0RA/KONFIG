...
"выполняется только администраторами.';uk='Недостатньо правий доступу.  Зміна властивостей регламентного завдання виконується тільки адміністраторами.'");
	КонецЕсли;
	...
	Иначе
		...
		Если Задание.Метаданные = Неопределено Тогда
			ИмяМетаданных        = НСтр("ru='<нет метаданных>';uk='<немає метаданих>'");
			СинонимМетаданных    = НСтр("ru='<нет метаданных>';uk='<немає метаданих>'");
			ИмяМетодаМетаданных  = НСтр("ru='<нет метаданных>';uk='<немає метаданих>'");
		Иначе
	...
	Если Действие <> "Изменить" Тогда
		Идентификатор = НСтр("ru='<будет создан при записи>';uk='<буде створений при записі>'");
		Использование = Ложь;
...
Процедура ОбновитьЗаголовокФормы()
	...
	Если Действие = "Изменить" Тогда
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru='%1 (Регламентное задание)';uk='%1 (Регламентне завдання)'"), Представление);
	Иначе
