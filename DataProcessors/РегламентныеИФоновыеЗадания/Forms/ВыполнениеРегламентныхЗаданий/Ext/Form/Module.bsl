...
Процедура ВыполнитьРегламентныеЗадания()
	...
	Если ОсталосьДоНачалаВыполнения <= 0 Тогда
		...
		Элементы.СтрокаСостояния.Заголовок = НСтр("ru='Выполняются регламентные задания... ';uk='Виконуються регламентні завдання... '");
	...
	Элементы.СтрокаСостояния.Заголовок = НСтр("ru='Ожидание выполнения регламентных заданий...';uk='Очікування виконання регламентних завдань...'");
