...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Баланс = ПолучитьБалансНаСервере();
...
Процедура КонтактНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ВзаимодействияКлиент.ВыбратьКонтакт(Предмет, текДанные.КакСвязаться, текДанные.ПредставлениеКонтакта,
		                                     текДанные.Контакт, Ложь, Истина, Истина) Тогда
...
Процедура ПроверитьЗаполнениеТелефона(Адресат, Отказ)
	...
	Адресат.НомерДляОтправки = СокрЛП(Адресат.КакСвязаться);
...
Функция ПолучитьБалансНаСервере()
	...
	Возврат "Баланс = " + ОтправкаSMS.ПолучитьБаланс() + " грн.";
