...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если Объект.Рассмотрено И ТребуетсяЗапросУведомленияОПрочтении Тогда
		...
		Результат = Вопрос(НСтр("ru='Отправитель запросил уведомление о прочтении. Отправить?';uk='Посилач запросив повідомлення про прочитання. Відправити?'"),
...
Процедура ЗаполнитьДополнительнуюИнформацию()
	...
	ДополнительнаяИнформацияОПисьме = НСтр("ru='Создано:';uk='Створено:'") + "   " + Объект.Дата + НСтр("ru='"
"Получено:';uk='"
"Отримано:'") + "  " + Объект.ДатаПолучения + НСтр("ru='"
"Важность:';uk='"
"Важливість:'") + "  " + Объект.Важность + НСтр("ru='"
"Кодировка:';uk='"
"Кодування:'") + " " + Объект.Кодировка;
