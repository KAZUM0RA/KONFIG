...
Процедура СоздатьСценарий(УзелИнформационнойБазы, Расписание = Неопределено) Экспорт
	...
	Наименование = НСтр("ru='Автоматический обмен данными с %1';uk='Автоматичний обмін даними з %1'");
...
Процедура УстановитьПараметрыРегламентногоЗадания(РегламентноеЗаданиеОбъект, РасписаниеРегламентногоЗадания, ТекущийОбъект)
	...
	НаименованиеРегламентногоЗадания = НСтр("ru='Выполнение обмена по сценарию: %1';uk='Виконання обміну по сценарію: %1'");
...
Процедура ЗаписатьРегламентноеЗадание(Отказ, РегламентноеЗаданиеОбъект)
	...
	Исключение
		...
		СтрокаСообщения = НСтр("ru='Произошла ошибка при сохранении расписания выполнения обменов. Подробное описание ошибки: %1';uk='Відбулася помилка при збереженні розкладу виконання обмінів. Докладний опис помилки: %1'");
