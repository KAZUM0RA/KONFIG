...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоНовый
		...
		Наименование = НСтр("ru='Сценарий обмена для %1';uk='Сценарій обміну для %1'");
...
Процедура ВыполнитьОбменДаннымиНаКлиенте()
	...
	Если НомерОбрабатываемойСтроки > КоличествоСтрок Тогда // выход из рекурсии
		...
		Состояние(НСтр("ru='Обмен данными выполнен.';uk='Обмін даними виконаний.'"), ?(ВыводитьПрогрессор, 100, Неопределено));
		Возврат; // выходим
	КонецЕсли;
