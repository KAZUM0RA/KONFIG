...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru='Настройка сценариев обменов данными для: [УзелИнформационнойБазы]';uk='Настроювання сценаріїв обмінів даними для: [УзелИнформационнойБазы]'");
...
Процедура ВыполнитьСценарий(Команда)
	...
	Сообщение = НСтр("ru='Выполняется обмен данными по сценарию ""%1""...';uk='Виконується обмін даними по сценарію ""%1""...'");
	...
	Если Отказ Тогда
		Сообщение = НСтр("ru='Сценарий обмена выполнен с ошибками.';uk='Сценарій обміну виконаний з помилками.'");
		Картинка = БиблиотекаКартинок.Ошибка32;
	Иначе
		Сообщение = НСтр("ru='Сценарий обмена успешно выполнен.';uk='Сценарій обміну успішно виконаний.'");
