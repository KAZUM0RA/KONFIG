...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЭтоДополнительноеСведение Тогда
		Заголовок = НСтр("ru='Подбор дополнительных сведений';uk='Добір додаткових відомостей'");
	Иначе
		Заголовок = НСтр("ru='Подбор дополнительных реквизитов';uk='Добір додаткових реквізитів'");
	КонецЕсли;
