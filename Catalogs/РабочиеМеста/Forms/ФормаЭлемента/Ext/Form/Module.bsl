...
"Продолжить сохранение с указанным наименованием?';uk='Зазначено неунікальне найменування робочого місця!"
"Можливо надалі це ускладнить ідентифікацію і вибір робочого місця."
"Рекомендується вказувати унікальне найменування робочих місць."
"Продовжити збереження із зазначеним найменуванням?'"),
