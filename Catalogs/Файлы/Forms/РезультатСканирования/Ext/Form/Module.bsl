...
Процедура ПреобразоватьПеречисленияВПараметрыИПолучитьПредставление()
	...
	Представление = Представление + СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Разрешение: %1 dpi. %2. ';uk='Дозвіл: %1 dpi. % 2. '"),
...
Функция ПолучитьТекстСообщенияОшибкиПреобразованияВPDF(ФайлРезультата)
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Не найден файл ""%1"". Проверьте, что установлена программа ImageMagick и указан правильный путь к программе преобразования в PDF в форме настроек сканирования.';uk='Не знайдений файл ""%1"". Перевірте, що встановлена програма Imagemagick і зазначений правильний шлях до програми перетворення в PDF у формі настроювань сканування.'"),
		ФайлРезультата);
