...
Процедура ОК(Команда)
	...
	СтруктураВозврата = Новый Структура("ПоказыватьДиалогСканера, Разрешение, Цветность, Поворот, РазмерБумаги, 
		| ДвустороннееСканирование, ИспользоватьImageMagickДляПреобразованияВPDF, 
		| ФорматСканированногоИзображения, КачествоJPG, СжатиеTIFF,
		| ФорматХраненияОдностраничный, ФорматХраненияМногостраничный",
		ПоказыватьДиалогСканера, Разрешение, Цветность, Поворот, РазмерБумаги, ДвустороннееСканирование, 
