...
Процедура ИмпортФайлов(Команда)
	...
	#Если Не ВебКлиент Тогда
		...
		КонецЕсли;
	#Иначе
		Предупреждение(НСтр("ru='В Веб-клиенте импорт файлов не поддерживается. Используйте команду ""Создать"" в списке файлов.';uk='У Веб-клієнтові імпорт файлів не підтримується. Використовуйте команду ""Створити"" у списку файлів.'"));
	#КонецЕсли
