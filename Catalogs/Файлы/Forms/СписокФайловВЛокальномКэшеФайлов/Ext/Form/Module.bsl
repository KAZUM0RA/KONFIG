...
Процедура УдалитьИзЛокальногоКэшаФайловВыполнить()
	...
	Текст = НСтр("ru='Удалить выбранные файлы из основного рабочего каталога ?';uk='Вилучити обрані файли з основного робочого каталогу ?'");
	...
	Если МассивСсылок.Количество() = 0 Тогда
		Предупреждение(НСтр("ru='Нельзя удалять из основного рабочего каталога файлы, занятые на редактирование';uk=' Не можна видаляти з основного робочого каталогу файли, зайняті на редагування'"));
	КонецЕсли;	
