...
Процедура ПередЗаписью(Отказ)
	...
	Если ДействияВФорме.Роли = "Редактирование" И Объект.УстановитьРолиНепосредственно И ПользовательИнфБазыРоли.Количество() = 0 Тогда
		...
		Ответ = Вопрос(НСтр("ru='Пользователю информационной базы не установлено ни одной роли. Продолжить?';uk='Користувачеві інформаційної бази не встановлене ні однієї ролі. Продовжити?'"),
		            РежимДиалогаВопрос.ДаНет, , , НСтр("ru='Запись пользователя информационной базы';uk='Запис користувача інформаційної бази'"));
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ВнешниеПользователи.ОбъектАвторизацииИспользуется(Объект.ОбъектАвторизации, Объект.Ссылка) Тогда
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
						НСтр("ru='Объект информационной базы уже используется для другого внешнего пользователя.';uk=""Об'єкт інформаційної бази вже використовується для іншого зовнішнього користувача."""), ,
...
"Сначала создайте обычного пользователя-администратора.';uk='Перший користувач інформаційної бази повинен мати повні права. Зовнішній користувач не може бути повноправним. Спочатку створіть звичайного користувача-адміністратора.'"),
				,
