...
Процедура Применить(Команда)
	...
	Если Не ВыбраноХотьОдноПравило Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Необходимо выбрать хотя бы одно правило для применения';uk='Необхідно вибрати хоч би одно правило для застосування'"),,"Список");
		Отказ = Истина;
	КонецЕсли;
	
	Если ДляПисемВПапке.Пустая() Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			НСтр("ru='Не выбрана папка к письмам которой будут применены правила';uk='Не вибрана тека до листів якої будуть застосовані правила'"),,"ДляПисемВПапке");
		Отказ = Истина;
	КонецЕсли;
