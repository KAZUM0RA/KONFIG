...
Процедура ЗаполнитьФормуПоОбъекту()
	...
	ПрочитатьПараметрыПрописиНаУкраинском();
	
	УстановитьСклоненияПараметровПрописиНаУкраинском(ЭтаФорма);
	УстановитьСуммуПрописьюНаУкраинском(ЭтаФорма);
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ЗависимыйКурсВалют Тогда
		...
		Если Не ЗначениеЗаполнено(Объект.Наценка) Тогда
			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
				НСтр("ru='Необходимо установить коэфициент подчинения курса';uk=' Необхідно встановити коэфiцiент підпорядкування курсу'"), ,
				"Объект.Наценка", ,
				Отказ);
		КонецЕсли;
...
////////////////////////////////////////////////////////////////////////////////////
// Обработчики события ПриИзменении элементов формы, связанных с прописью
...
////////////////////////////////////////////////////////////////////////////////
// Другие обработчики событий элементов формы
...
//
&НаСервере
Процедура ПрочитатьПараметрыПрописиНаУкраинском()
...
// Устанавливает видимость элементов управления формы, ответственных
...
// Устанавливает склонение заголовков элементов формы
...
//
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьСклоненияПараметровПрописиНаУкраинском(Форма)
