...
Процедура ПередЗаписью(Отказ)
	...
	Если ЗначениеЗаполнено(ГлавнаяЗадача) И 
		...
		ВызватьИсключение НСтр("ru='Собственная задача бизнес-процесса не может быть указана как главная задача.';uk='Власне завдання бізнес-процесу не може бути зазначене як головне завдання.'");
...
"%3"
"';uk='%1, %2 выполнил(а) задачу:"
"%3"
"'"),
		НСтр("ru='%1, %2 отклонил(а) задачу:"
"%3"
"';uk='%1, %2 отклонил(а) задачу:"
"%3"
"'"));
...
"%3"
"';uk='%1, %2 вернул(а) задачу на доработку:"
"%3"
"'");
	Иначе
		СтрокаФормат = ?(Выполнено,
...
"%3"
"';uk='%1, %2 подтвердил(а) выполнение задачи:"
"%3"
"'"),
			НСтр("ru='%1, %2 подтвердил(а) отмену задачи:"
"%3"
"';uk='%1, %2 подтвердил(а) отмену задачи:"
"%3"
"'"));
	КонецЕсли;
