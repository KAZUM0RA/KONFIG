...
Процедура ЗаполнитьДерево()
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ЭтоГруппа  Тогда
			...
			Иначе
				СтрокаГруппыУпровень = СтрокаГруппыЭлементы.Добавить();
				СтрокаГруппыУпровень.Настройка = Выборка.Ссылка;
				СтрокаГруппыУпровень.ЭтоГруппа = Выборка.ЭтоГруппа;
				СтрокаГруппыУпровень.НомерКартинки = Выборка.НомерКартинки;
				СтрокаГруппыЭлементы = СтрокаГруппыУпровень.ПолучитьЭлементы();
			КонецЕсли;
		Иначе
			Если  ЗначениеЗаполнено(Выборка.Родитель) Тогда
				СтрокаНастройки = СтрокаГруппыЭлементы.Добавить();
			Иначе
				СтрокаНастройки = НастройкиЭлементы.Добавить();
			КонецЕсли;
			СтрокаНастройки.Настройка = Выборка.Ссылка;
