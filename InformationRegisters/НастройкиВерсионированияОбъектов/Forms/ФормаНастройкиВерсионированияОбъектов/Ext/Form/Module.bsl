...
Процедура УстановитьВариантВерсионированияПриПроведении(Команда)
	...
	Если ВыбранТипДокументовБезВозможностиПроведения() Тогда
		Предупреждение(НСтр("ru='Документам, которые не могут быть проведены, будет установлен режим версионирования ""Версионировать при записи"".';uk='Документам, які не можуть бути проведені, буде встановлений режим версiонування ""Версiонувати при записі"".'"));
	КонецЕсли;
