...
Процедура ЗагрузитьПравила(Команда)
	...
	Если ИсточникПравил = 1 Тогда // из файла
		...
		Если ПодключитьРасширениеРаботыСФайлами()Тогда
			...
			+ НСтр("ru='Архивы ZIP';uk='Архіви ZIP'") + "(*.zip)|*.zip";
			...
			ДиалогОткрытияФайла.Заголовок = НСтр("ru='Укажите из какого файла загрузить правила';uk='Укажіть із якого файлу завантажити правила'");
...
"Перейти в журнал регистрации?';uk='У процесі завантаження правил були виявлені помилки. Перейти в журнал реєстрації?'"
		);
	...
	Иначе
		...
		Предупреждение(НСтр("ru='Правила успешно загружены в информационную базу.';uk='Правила успішно завантажені в інформаційну базу.'"));
...
""
"[ИнформацияОПравилах]';uk='Використання правил, завантажених з файлу, може привести до помилок при переході на нову версію програми.  [ИнформацияОПравилах]'"
		);
