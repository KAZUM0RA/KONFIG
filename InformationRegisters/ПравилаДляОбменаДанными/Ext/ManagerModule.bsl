...
"Возможно выбран не тот файл, либо XML-файл имеет некорректную структуру. Выберите корректный файл.';uk='Не вдалося визначити вид правил через помилку в розбору Xml-Файлу [ИмяФайла].  Можливо обраний не той файл, або Xml-Файл має некоректну структуру. Виберіть коректний файл.'");
...
"Возможно выбран не тот файл, либо XML-файл имеет некорректную структуру. Выберите корректный файл.';uk='Не вдалося визначити вид правил через помилку у форматі правил Xml-Файлу [ИмяФайла]. Можливо обраний не той файл, або Xml-Файл має некоректну структуру. Виберіть коректний файл.'");
			НСтрока = СтроковыеФункцииКлиентСервер.ВставитьПараметрыВСтроку(НСтрока, Новый Структура("ИмяФайла", ИмяФайла));
			ОбменДаннымиСервер.СообщитьОбОшибке(НСтрока, Отказ);
