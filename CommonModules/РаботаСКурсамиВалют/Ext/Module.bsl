...
Процедура ЗагрузитьАктуальныйКурс() Экспорт
	...
	ИмяСобытия = НСтр("ru='Валюты.Загрузка курсов валют';uk='Валюти.Завантаження курсів валют'");
	...
	ЗаписьЖурналаРегистрации(
		...
		,
		,
		НСтр("ru='Начата регламентная загрузка курсов валют';uk='Почате регламентне завантаження курсів валют'")
	);
	...
	Иначе
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("ru='Завершена регламентная загрузка курсов валют.';uk='Завершене регламентне завантаження курсів валют.'")
		);
	КонецЕсли;
