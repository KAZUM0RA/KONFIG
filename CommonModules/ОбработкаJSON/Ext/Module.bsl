...
//
Функция ПрочитатьJSON_Удалить(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
...
//
Функция ЗаписатьJSON_Удалить(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь) Экспорт 
