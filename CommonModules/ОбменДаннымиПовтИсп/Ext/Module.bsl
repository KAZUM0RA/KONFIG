...
Функция ТабличныеЧастиПланаОбмена(Знач ИмяПланаОбмена) Экспорт
	...
	ТабличныеЧасти = ТабличныеЧастиОбъекта(Метаданные.ПланыОбмена[ИмяПланаОбмена]);
...
Функция КаталогВременногоХранилищаФайлов() Экспорт
	...
	Иначе
		...
		Если Не Каталог.Существует() Тогда
			...
			СтрокаСообщения = НСтр("ru='Каталог временных файлов сообщений обмена не существует: ""%1""';uk='Каталог тимчасових файлів повідомлень обміну не існує: ""%1""'");
