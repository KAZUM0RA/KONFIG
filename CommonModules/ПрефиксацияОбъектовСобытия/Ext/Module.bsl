...
Процедура ПроверитьНомерОбъектаПоДате(Объект)
	...
	Если Не ПрефиксацияОбъектов.ДатыОбъектаОдногоПериода(Выборка.Дата, Объект.Дата, Объект.Ссылка) Тогда
...
Процедура ПроверитьНомерОбъектаПоДатеИОрганизации(Объект)
	...
	Если ПрефиксацияОбъектов.ДатаИлиОрганизацияОбъектаИзменена(Объект.Ссылка, Объект.Дата, Объект.Организация, Объект.Метаданные().ПолноеИмя()) Тогда
...
Процедура ПроверитьКодОбъектаПоОрганизации(Объект)
	...
	Если ПрефиксацияОбъектов.ОрганизацияОбъектаИзменена(Объект.Ссылка, Объект.Организация, Объект.Метаданные().ПолноеИмя()) Тогда
