...
Функция ОписанияНачальногоЗаполненияПрофилейГруппДоступа() Экспорт
	...
	ОписанияПрофилей = Новый Массив;
		...
		//Добавляем профиль "Расчетчик"
		ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
		ОписаниеПрофиля.Идентификатор = Строка(Справочники.ПрофилиГруппДоступа.Расчетчик.УникальныйИдентификатор());
		ОписаниеПрофиля.Наименование = НСтр("ru='Расчетчик';uk='Розраховувач'");
		ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПодсистемыНачисления");
		ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПодсистемыЛицевыеСчета");
		ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПодсистемыПриборыУчета"); 
		// Виды доступа
		ОписаниеПрофиля.ВидыДоступа.Добавить("Организации", "ВначалеВсеРазрешены");
		ОписаниеПрофиля.ВидыДоступа.Добавить("Здания", "ВначалеВсеРазрешены");
		
		ОписанияПрофилей.Добавить(ОписаниеПрофиля);
		
		//Добавляем профиль "Паспортный стол"
		ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
		ОписаниеПрофиля.Идентификатор = Строка(Справочники.ПрофилиГруппДоступа.ПаспортныйСтол.УникальныйИдентификатор());
		ОписаниеПрофиля.Наименование = НСтр("ru='Паспортный стол';uk='Паспортний стіл'");
		ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПодсистемыПаспортныйСтол");
		// Виды доступа
		ОписаниеПрофиля.ВидыДоступа.Добавить("Организации", "ВначалеВсеРазрешены");
		ОписаниеПрофиля.ВидыДоступа.Добавить("Здания", "ВначалеВсеРазрешены");
		...
		//Добавить профиль "АДМ"
		ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
		ОписаниеПрофиля.Идентификатор = Строка(Справочники.ПрофилиГруппДоступа.АварийноДиспетчерскаяСлужба.УникальныйИдентификатор());
		ОписаниеПрофиля.Наименование = НСтр("ru='Аварийно диспетчерская служба';uk='Аварійно диспетчерська служба'");
		ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПодсистемыАварийноДиспечерскаяСлужба");
		// Виды доступа
		ОписаниеПрофиля.ВидыДоступа.Добавить("Организации", "ВначалеВсеРазрешены");
		ОписаниеПрофиля.ВидыДоступа.Добавить("Здания", "ВначалеВсеРазрешены");
		...
		//Добавить профиль "Запасы"
		ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
		ОписаниеПрофиля.Идентификатор = Строка(Справочники.ПрофилиГруппДоступа.Запасы.УникальныйИдентификатор());
		ОписаниеПрофиля.Наименование = НСтр("ru='Запасы';uk='Запаси'");
		...
		//Добавить профиль "Голосование"                                                   
		ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
		ОписаниеПрофиля.Идентификатор = Строка(Справочники.ПрофилиГруппДоступа.Голосование.УникальныйИдентификатор());
		ОписаниеПрофиля.Наименование = НСтр("ru='Голосование';uk='Голосування'");           
		ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеПодсистемыГолосование");
		// Виды доступа
		ОписаниеПрофиля.ВидыДоступа.Добавить("Организации", "ВначалеВсеРазрешены");
		ОписаниеПрофиля.ВидыДоступа.Добавить("Здания", "ВначалеВсеРазрешены");
		...
		//Добывить профиль "Мобильное приложение"
		ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
		ОписаниеПрофиля.Идентификатор = Строка(Справочники.ПрофилиГруппДоступа.МобильноеПриложение.УникальныйИдентификатор());
		ОписаниеПрофиля.Наименование = НСтр("ru='Мобильное приложение';uk='Мобільний додаток'");
		ОписаниеПрофиля.Роли.Добавить("МобильноеПриложение");
		// Виды доступа
		ОписаниеПрофиля.ВидыДоступа.Добавить("Организации", "ВначалеВсеРазрешены");
		ОписаниеПрофиля.ВидыДоступа.Добавить("Здания", "ВначалеВсеРазрешены");
...
Процедура ЗаполнитьВозможныеПраваПоЗначениямДоступа(Знач ВозможныеПрава) Экспорт
	...
	Право.Синоним       = НСтр("ru='Чтение папок и файлов';uk='Читання папок і файлів'");
	Право.Сокращение    = НСтр("ru='Чтение';uk='Читання'");
	Право.Заголовок     = НСтр("ru='Чт';uk='Чт'");
	...
	Право.Синоним       = НСтр("ru='Добавление папок и файлов';uk='Додавання папок і файлів'");
	Право.Сокращение    = НСтр("ru='Добавление';uk='Додавання'");
	Право.Заголовок     = НСтр("ru='Доб';uk='Доб'");
	...
	Право.Синоним       = НСтр("ru='Изменение папок и файлов';uk='Зміна папок і файлів'");
	Право.Сокращение    = НСтр("ru='Изменение';uk='Зміна'");
	Право.Заголовок     = НСтр("ru='Изм';uk='Изм'");
	// Требуемая роль (одна из указанных).
	Право.ТребуемаяРоль.Добавить("РаботаСПапкамиФайлов");
	Право.ТребуемыеПрава.Добавить("ЧтениеПапокИФайлов");
	// Права для стандартных шаблонов ограничений доступа.
	...
	Право.Синоним       = НСтр("ru='Пометка удаления папок и файлов';uk='Позначка видалення папок і файлів'");
	Право.Сокращение    = НСтр("ru='Пометка удаления';uk='Позначка видалення'");
	Право.Заголовок     = НСтр("ru='ПомУд';uk='ПомУд'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ЧтениеПапокИФайлов");
	Право.ТребуемыеПрава.Добавить("ИзменениеПапокИФайлов");
	// Требуемая роль (одна из указанных)
	...
	Право.Синоним       = НСтр("ru='Управление правами папок файлов';uk='Керування правами папок файлів'");
	Право.Сокращение    = НСтр("ru='Управление правами';uk='Керування правами'");
	Право.Заголовок     = НСтр("ru='Адм';uk='Адм'");
	// Права, требуемые для этого права.
	Право.ТребуемыеПрава.Добавить("ЧтениеПапокИФайлов");
	// Требуемая роль (одна из указанных)
	Право.ТребуемаяРоль.Добавить("РаботаСПапкамиФайлов");
