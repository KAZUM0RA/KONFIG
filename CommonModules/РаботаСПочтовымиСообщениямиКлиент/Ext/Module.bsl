...
Процедура ПроверитьНаличиеУчетнойЗаписиДляОтправкиПочты(ОбработчикРезультата) Экспорт
	...
	Иначе
		...
		Иначе	
			ТекстСообщения = НСтр("ru='Для отправки письма требуется настройка учетной записи электронной почты.';uk='Для відправлення листа потрібна настройки облікового запису електронної пошти.'");
...
"%1';uk='Перевірка параметрів облікового запису завершився з помилками:"
"%1'"), СообщениеОбОшибке ),,
