...
""
"[ЗаголовокСистемы]"
"[ДатаВыполнения(ДЛФ='DD')]"";uk=""Сформовані звіти:"
""
"[СформированныеОтчеты]"
""
"[СпособДоставки]"
...
Функция ШаблонИмениАрхива() Экспорт
	Возврат НСтр("ru=""[НаименованиеРассылки]_[ДатаВыполнения(ДФ='yyyy-MM-dd')]"";uk=""[НаименованиеРассылки]_[ДатаВыполнения(ДФ='yyyy - MM - dd')]"""); // Формат даты не локализуется
КонецФункции
...
Функция СписокВариантовЗаполненияРасписаний() Экспорт
	...
	СписокВариантов.Добавить(2, НСтр("ru='Каждый второй день';uk='Кожен другий день'"));
	СписокВариантов.Добавить(3, НСтр("ru='Каждый четвертый день';uk='Кожен четвертий день'"));
	СписокВариантов.Добавить(4, НСтр("ru='По будням';uk='По буднях'"));
	СписокВариантов.Добавить(5, НСтр("ru='По выходным';uk='По вихідних'"));
	СписокВариантов.Добавить(6, НСтр("ru='По понедельникам';uk='Щопонеділка'"));
	СписокВариантов.Добавить(7, НСтр("ru='По пятницам';uk=""Щоп'ятниці"""));
	СписокВариантов.Добавить(8, НСтр("ru='По воскресеньям';uk='Щонеділі'"));
	СписокВариантов.Добавить(9, НСтр("ru='В первый день месяца';uk='У перший день місяця'"));
	СписокВариантов.Добавить(10, НСтр("ru='В последний день месяца';uk='У останній день місяця'"));
	СписокВариантов.Добавить(11, НСтр("ru='Каждый квартал десятого числа';uk='Кожного кварталу десятого числа'"));
...
Функция СтрокаСообщенийПользователю(МассивОшибок = Неопределено, ДобавитьДежурнуюФразу = Истина) Экспорт
	...
	Если ВсеОшибки <> "" И ДобавитьДежурнуюФразу Тогда
		ВсеОшибки = ВсеОшибки + Отступ + "---" + Отступ + НСтр("ru='Подробности см. в журнале регистрации.';uk='Подробиці см в журналі реєстрації.'");
	КонецЕсли;
