...
#Если ВебКлиент Тогда
	ТекстУточнения = НСтр("ru='При работе через веб, требуется браузер Internet Explorer под управлением операционной системы Windows.';uk=' При роботі через веб, потрібен браузер Internet Explorer під керуванням операційної системи Windows.'");
#Иначе		
	ТекстУточнения = "";	
#КонецЕсли
	ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru='Не удалось сформировать печатную форму: %1. "
"Для вывода печатных форм в формате OpenOffice.org Writer требуется, чтобы на компьютере был установлен пакет OpenOffice.org. %2';uk=""Не вдалося сформувати друковану форму: %1.   Для виводу друкованих форм у форматі Openoffice.org Writer потрібно, щоб на комп'ютері був установлений пакет Openoffice.org. % 2"""),
