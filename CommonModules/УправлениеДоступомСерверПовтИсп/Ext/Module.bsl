...
//    - КоллекцияСиноним         - Строка(1000) - НСтр("ru='Справочники';uk='Довідники'"), ...
...
//    - ТаблицаСиноним           - Строка(1000) - НСтр("ru='Справочники';uk='Довідники'") + "." + ОбъектМетаданныхСиноним
//
Функция СинонимыТаблиц() Экспорт
	...
	СинонимыКоллекцийТаблиц.Вставить("Справочники",             НСтр("ru='Справочник';uk='Довідник'"));
	СинонимыКоллекцийТаблиц.Вставить("Документы",               НСтр("ru='Документ';uk='Документ'"));
	СинонимыКоллекцийТаблиц.Вставить("ЖурналыДокументов",       НСтр("ru='Журнал документов';uk='Журнал документів'"));
	СинонимыКоллекцийТаблиц.Вставить("ПланыВидовХарактеристик", НСтр("ru='План видов характеристик';uk='План видів характеристик'"));
	СинонимыКоллекцийТаблиц.Вставить("ПланыСчетов",             НСтр("ru='План счетов';uk='План рахунків'"));
	СинонимыКоллекцийТаблиц.Вставить("ПланыВидовРасчета",       НСтр("ru='План видов расчета';uk='План видів розрахунків'"));
	СинонимыКоллекцийТаблиц.Вставить("РегистрыСведений",        НСтр("ru='Регистр сведений';uk='Регістр відомостей'"));
	СинонимыКоллекцийТаблиц.Вставить("РегистрыНакопления",      НСтр("ru='Регистр накопления';uk='Регістр нагромадження'"));
	СинонимыКоллекцийТаблиц.Вставить("РегистрыБухгалтерии",     НСтр("ru='Регистр бухгалтерии';uk='Регістр бухгалтерії'"));
	СинонимыКоллекцийТаблиц.Вставить("РегистрыРасчета",         НСтр("ru='Регистр расчета';uk='Регістр розрахунків'"));
	СинонимыКоллекцийТаблиц.Вставить("БизнесПроцессы",          НСтр("ru='Бизнес-процесс';uk='Бізнес-Процес'"));
	СинонимыКоллекцийТаблиц.Вставить("Задачи",                  НСтр("ru='Задача';uk='Завдання'"));
	...
	СинонимыКоллекцийОбъектовМетаданных.Вставить("Справочники",             НСтр("ru='Справочники';uk='Довідники'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("Документы",               НСтр("ru='Документы';uk='Документи'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("ЖурналыДокументов",       НСтр("ru='Журналы документов';uk='Журнали документів'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("ПланыВидовХарактеристик", НСтр("ru='Планы видов характеристик';uk='Плани видів характеристик'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("ПланыСчетов",             НСтр("ru='Планы счетов';uk='Плани рахунків'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("ПланыВидовРасчета",       НСтр("ru='Планы видов расчета';uk='Плани видів розрахунків'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("РегистрыСведений",        НСтр("ru='Регистры сведений';uk='Регістри відомостей'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("РегистрыНакопления",      НСтр("ru='Регистры накопления';uk='Регістри нагромадження'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("РегистрыБухгалтерии",     НСтр("ru='Регистры бухгалтерии';uk='Регістри бухгалтерії'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("РегистрыРасчета",         НСтр("ru='Регистры расчета';uk='Регістри розрахунків'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("БизнесПроцессы",          НСтр("ru='Бизнес-процессы';uk='Бізнес-Процеси'"));
	СинонимыКоллекцийОбъектовМетаданных.Вставить("Задачи",                  НСтр("ru='Задачи';uk='Завдання'"));
			...
			Иначе
				...
				Если Метаданные.НайтиПоПолномуИмени(Таблица) = Неопределено Тогда
					ПояснениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Не найдена таблица ""%1"".';uk='Не знайдена таблиця ""%1"".'"),
						Таблица);
				ИначеЕсли Право <> "Чтение"
					...
					ПояснениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Не найдено право ""%1"".';uk='Не знайдене право ""%1"".'"),
						Право);
				...
				ИначеЕсли ПредопределенныеВидыДоступа.Получить(ВидДоступа) = Неопределено Тогда
					ПояснениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru='Не найден вид доступа ""%1"".';uk='Не знайдений вид доступу ""%1"".'"),
						ВидДоступа);
				КонецЕсли;
			КонецЕсли;
...
"""%1""."
""
"';uk='Ошибка в строке описания вида ограничений права объекта метаданных:"
"""%1""."
""
...
Функция ОписанияНачальногоЗаполненияПрофилейГруппДоступа() Экспорт
	...
	Если НЕ ОбщегоНазначенияПовтИсп.РазделениеВключено() Тогда
		...
		КонецЕсли;
	КонецЕсли;
	ОписаниеПрофиляАдминистратор.Описание = НСтр("ru='Предназначен для"
...
Функция КлючСеанса() Экспорт
	...
	Если НачалоСеанса = Неопределено Тогда
		ВызватьИсключение(НСтр("ru='Не найден текущий сеанс информационной базы';uk='Не знайдений поточний сеанс інформаційної бази'"));
	КонецЕсли;
