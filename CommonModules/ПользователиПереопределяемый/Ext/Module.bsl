...
"Продолжить?';uk='У список користувачів програми додається перший користувач,  тому він буде автоматично включений у групу доступу Адміністратори.  Продовжити?'")
	// Конец СтандартныеПодсистемы.УправлениеДоступом
...
""
"Пользователей информационной базы следует создавать в режиме 1С:Предприятия.';uk='Обнаружено, что пользователь информационной базы"
"с ролью ""Полные права"" был создан в Конфигураторе:"
""
"- пользователь не найден в справочнике Пользователи,"
"- пользователь зарегистрирован в справочнике Пользователи,"
