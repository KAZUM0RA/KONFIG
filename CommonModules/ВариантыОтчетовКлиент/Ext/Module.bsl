...
//   ЗаголовокПанелиОтчетов  (Строка) Заголовок, который будет установлен для панели отчетов. Локализуем.
//   ПараметрыВыполненияКоманды (...) Передается "как есть" из параметров обработчика команды.
//   КартинкаФормы          (Картина) Необязательный. Картинка, которая будет установлена в панели отчетов.
// 
Процедура ОткрытьПанельОтчетов(ИмяРаздела, ЗаголовокПанелиОтчетов, ПараметрыВыполненияКоманды,
	...
	Параметры.Подсистемы    = ИмяРаздела;
	Параметры.ИмяФормы      = ЗаголовокПанелиОтчетов;
	...
	Если ТипЗнч(Владелец) = Тип("ОкноКлиентскогоПриложения") И Владелец.Основное = Истина Тогда
		Уникальность = ИмяРаздела +"."+ СтрЗаменить(ТРег(ЗаголовокПанелиОтчетов), " ", "") +"."+ Уникальность;
	КонецЕсли;
