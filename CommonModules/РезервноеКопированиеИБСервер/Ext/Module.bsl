...
// Возвращает значение периода по заданному интревалу времени.
//
// Параметры:
//	ИнтервалВремени - Число - интервал времени в секундах.
//	
// Возвращаемое значение - Струткура с полями:
...
//
Процедура УстановитьДатуСледующегоАвтоматическогоКопирования(НачальнаяНастройка = Ложь, ПараметрыРезервногоКопированияИБНаКлиенте) Экспорт
...
//	ПараметрыРезервногоКопированияИБНаКлиенте - Структура - параметры резервного копирования.
//
Процедура ОстановитьАвтоматическоеРезервноеКопирование(ПроводитьПриЗавершении = Ложь, ПараметрыРезервногоКопированияИБНаКлиенте) Экспорт
...
Функция СформироватьКлиентскуюСтруктуру(ИсходнаяСтруктура)
	...
	КлиентскаяСтруктура = Новый Структура("ДатаПоследнегоОповещения, ОтложенноеРезервноеКопирование, ПараметрОповещения, КоличествоПользователей, ДатаПоследнегоРезервногоКопирования");
...
//
// Параметры:
//	ПараметрыРезервногоКопированияИБНаКлиенте - Структура - параметры резервногот копирования.
//
...
Функция ПолучитьНастройкиОбработчиковОжидания() Экспорт
	...
	ПараметрыКопирования = ПолучитьНастройкиРезервногоКопирования();
...
//
// Возвращаемое значение - Чмсло - размер файла в килобайтах.
//
