...
Процедура ОтложенноеИнтерактивноеРезервноеКопирование(ПараметрыКопирования, КоличествоПользователей) Экспорт
	...
	Иначе
		...
		Если КоличествоПользователей = 1 Тогда
			...
			ТекстВопроса = НСтр("ru='В данный момент с базой больше никто не работает. Выполнить резервное копирование?';uk=' У цей момент із базою більше ніхто не працює. Виконати резервне копіювання?'");
			Ответ = Вопрос(ТекстВопроса, РежимДиалогаВопрос.ДаНет, 30, КодВозвратаДиалога.Да, 
				Нстр("ru='Провести резервное копирование прямо сейчас';uk='Провести резервне копіювання пряме зараз'"), КодВозвратаДиалога.Да);
